            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                    ...
                    <div class="bg-white rounded-xl p-8 shadow-lg">
                        <h3 class="text-xl font-semibold text-arc-gray mb-2">${t.pricing.starter.name}</h3>
                        <div class="text-4xl font-bold text-arc-blue mb-2">${t.pricing.starter.price}<span class="text-lg text-gray-500">/${t.pricing.monthly}</span></div>
                        <p class="text-gray-600 mb-6">${t.pricing.starter.description}</p>
                        
                        <ul class="space-y-3 mb-8">
                            ${t.pricing.starter.features.map(feature => `
                                <li class="flex items-center">
                                    <i class="fas fa-check text-arc-green ${isRTL ? 'ml-3' : 'mr-3'}"></i>
                                    <span class="text-gray-600">${feature}</span>
                                </li>
                            `).join('')}
                        </ul>
                        
                        <a href="#" class="w-full bg-arc-blue text-white py-3 px-6 rounded-lg hover:bg-opacity-90 transition-colors font-semibold text-center block">
                            ${t.pricing.starter.cta}
                        </a>
                    </div>
                    
                    <!-- Professional Plan (Most Popular) -->
                    <div class="bg-white rounded-xl p-8 shadow-xl border-2 border-arc-orange relative">
                        <div class="absolute -top-3 ${isRTL ? 'right-4' : 'left-4'} bg-arc-orange text-white px-4 py-1 rounded-full text-sm font-semibold">
                            ${t.pricing.professional.popular}
                        </div>
                        
                        <h3 class="text-xl font-semibold text-arc-gray mb-2">${t.pricing.professional.name}</h3>
                        <div class="text-4xl font-bold text-arc-orange mb-2">${t.pricing.professional.price}<span class="text-lg text-gray-500">/${t.pricing.monthly}</span></div>
                        ...
                        <a href="#" class="w-full bg-arc-orange text-white py-3 px-6 rounded-lg hover:bg-opacity-90 transition-colors font-semibold text-center block">
                    ...
                    <div class="bg-white rounded-xl p-8 shadow-lg">
                        ...
                        <div class="text-4xl font-bold text-arc-gray mb-2">${t.pricing.enterprise.price}</div>
                        ...
                        <a href="#" class="w-full bg-arc-gray text-white py-3 px-6 rounded-lg hover:bg-opacity-90 transition-colors font-semibold text-center block">
        ...
        <section id="community" class="py-20 bg-white">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid md:grid-cols-3 gap-8">
                    <div class="text-center p-8 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-xl text-white">
                        ...
                        <div class="text-2xl font-bold">5,000+ ${t.community.discord.members}</div>
                    </div>
                    ...
                    <div class="text-center p-8 bg-gradient-to-br from-blue-500 to-cyan-600 rounded-xl text-white">
                        ...
                        <div class="text-2xl font-bold">1,200+ ${t.community.forum.topics}</div>
                    </div>
                    
                    <div class="text-center p-8 bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl text-white">
                        ...
                        <div class="text-2xl font-bold">800+ ${t.community.github.stars}</div>
                    </div>
                </div>
            </div>
        </section>
